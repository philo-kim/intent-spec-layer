...
|---|---|---|---|
| duplicate submit / stale state / permission / timeout / rollback / cancellation / retry / recovery | L0 / L1 invariant / product decision / platform rule / common UX expectation / sample import | accept / reject / decide later | add / modify / none |
